...
public class BinarySearch {
    ...
    // because half of the search space is eliminated (in a sense, searched) on each iteration.
    // This is more efficient than a simple search through all the elements, which would be O(n).
    // However, to perform a binary search, the array must be sorted, an operation that is usually O(n log(n)).
    //
